...
function ComingSoon() {
  return (
    <div className="w-full h-[100%] flex flex-col items-center justify-center text-center font-['Poppins']">
      <img src={ComingSoonImg} alt="404" className='h-30 md:h-40 lg:h-50 xl:h-55' />
