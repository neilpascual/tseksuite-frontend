...
function DashboardPage() {
  ...
  return (
    <>
      <div className="h-screen w-full px-3 sm:px-6 md:px-8 py-6 mt-15 ">
        {/* Header */}
        ...
        <div className="flex flex-row justify-between items-center gap-4 mb-4">
          {/* Left: Title */}
          <div className="text-[#2E99B0] text-md sm:text-md md:text-xl lg:text-2xl xl:text-3xl font-['Poppins']">
            All Applicants
          </div>
